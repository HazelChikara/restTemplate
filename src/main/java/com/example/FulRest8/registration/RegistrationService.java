...
import com.example.FulRest8.appuser.AppUserRole;
import com.example.FulRest8.appuser.AppUserService;
import com.example.FulRest8.email.EmailSender;
...
//                        register the user role
    ...
    String link = "http://localhost:2022/api/v1/registration/confirm?token=" + token;
        emailSender.send(
                request.getEmail(),
